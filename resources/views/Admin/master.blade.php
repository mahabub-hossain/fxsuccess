...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{asset('admin/vendors/bower_components/flatpickr/dist/flatpickr.min.css')}}" />
        <link rel="stylesheet" href="{{asset('admin/vendors/bower_components/nouislider/distribute/nouislider.min.css')}}">
        <link rel="stylesheet" href="{{asset('admin/vendors/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.css')}}">
        <link rel="stylesheet" href="{{asset('admin/vendors/bower_components/trumbowyg/dist/ui/trumbowyg.min.css')}}">
        <link rel="stylesheet" href="{{asset('admin/vendors/bower_components/rateYo/min/jquery.rateyo.min.css')}}">
...
<?php
$themeid = DB::table('themes')->where('id','=',1)->first();
?>
    <body data-sa-theme="{{$themeid->themeid}}" onload="startTime()">
        <main class="main">
                    ...
                    <ul class="navigation">
                        ...
                        <li class="navigation__sub">
                           ...
                           <li class="navigation__sub">
                            ...
                            <li class="navigation__sub "> <!-- Start Trading Signal -->
                                <a href=""><i class="zmdi zmdi-view-list"></i>Trading Signal</a>
                                <ul style="display:block">
                                     <li class="navigation__sub navigation__sub--toggled">
                                    <a href=""><i class="zmdi zmdi-menu"></i> Currency Pair</a>
                                    <ul class="ml-3" style="display: block;">
                                    <li><a href="{{route('currency.index')}}">Manage Currency </a></li>
                                     <li><a href="">Add Currency </a></li>
                                     </ul>
                                   </li>
                                    <li class="navigation__sub navigation__sub--toggled">
                                      <a href=""><i class="zmdi zmdi-menu"></i> Signal Management</a>
                                    <ul class="ml-3" style="display:block">
                                    <li>
                                     <a href="">Manage Signal</a>
                                    </li>
                       ...
                       <li class="navigation__sub">
                            <a href=""><i class="zmdi zmdi-view-list"></i> Forex Signal</a>
                            <ul>
                            <li><a href="">Manage Signal</a></li>
                            <li><a href="">Create Signal</a></li>
                           </ul>
                       </li>
                    </ul>
                </div>
            ...
            <div class="themes">
    <div class="scrollbar-inner">
        <a href="" class="themes__item active"  id="1" data-sa-value="1"><img src="{{asset('admin/img/bg/1.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="2" data-sa-value="2"><img src="{{asset('admin/img/bg/2.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="3" data-sa-value="3"><img src="{{asset('admin/img/bg/3.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="4" data-sa-value="4"><img src="{{asset('admin/img/bg/4.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="5" data-sa-value="5"><img src="{{asset('admin/img/bg/5.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="6" data-sa-value="6"><img src="{{asset('admin/img/bg/6.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="7" data-sa-value="7"><img src="{{asset('admin/img/bg/7.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="8" data-sa-value="8"><img src="{{asset('admin/img/bg/8.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="9" data-sa-value="9"><img src="{{asset('admin/img/bg/9.jpg')}}" alt=""></a>
        <a href="" class="themes__item"  id="10" data-sa-value="10"><img src="{{asset('admin/img/bg/10.jpg')}}" alt=""></a>
       ...
       <script src="{{asset('admin/vendors/bower_components/jquery-mask-plugin/dist/jquery.mask.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/dropzone/dist/min/dropzone.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/flatpickr/dist/flatpickr.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/nouislider/distribute/nouislider.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/trumbowyg/dist/trumbowyg.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/rateYo/min/jquery.rateyo.min.js')}}"></script>
       <script src="{{asset('admin/vendors/bower_components/jquery-text-counter/textcounter.min.js')}}"></script>
        ...
        <script>
            ...
            $(document).ready(function(){
                    $(".themes__item").click(function(){
                        ...
                        $.get('/themeoption/'+ theme_id, function (data) {
